...
char* FilePath_Results = "C:/PhD_Examples/Results_CrudeOil/BDClass(DUAL)_new";//G:/Antonis/PhD_Examples
...
int Aux_Dual_Slave_Bounded(IloCplex cplexDualSlave_ptr, double *DTransposeY, double *AuxDualSlaveObjFunction, double *AuxPrimalSlaveObjFunction, int *FirstTime_ptr, int loop_ptr, int *NoOfTimes_ptr, IloModel modelDualSlaveAux_ptr_ptr) {
...
int BendersIteration(IloModel modelMaster_ptr, IloModel modelDualSlave_ptr, IloModel modelDualSlaveAux_ptr, IloModel modelDualSlaveFeasAux_ptr, int *loop_iter, int *NoofTimesWorseSolutionFound) {
	...
	while (UpperBoundGlobal - LowerBound > epsilon && loop < 5000 && duration < maxhours * 3600) {
		...
		if (ClassicalDualStatus == 4) { //---------IF CLASSICAL DUAL SLAVE IS UNBOUNDED-----
			...
			//	}
			//}
			//else if (FoundFeasibleSolution == true && SameMasterSolution == false && NeedClassicalDSP == false) {
			...
			//		status = Aux_Dual_Slave_Bounded(cplexDualSlaveAux_ptr, &DTransposeY, &AuxDualSlaveObjFunction, &AuxPrimalSlaveObjFunction, &FirstTime, loop, &NoOfTimes, modelDualSlaveAux_ptr);
			//		if (status != 0) {
...
int PrintOptimalSolution(char* FilePath_Results_ptr, int loop_iter, int NoofTimesWorseSolutionFound) {
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_OptimalSolution.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_LowerBound.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_UpperBound.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_UpperBoundGlobal.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_UpperBoundAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_UpperBoundGlobalAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_dTransY.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_cTransX.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_bTransU.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_cTransXAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_bTransUAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_CurrentHeta.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_BestPrimalSlaveObjSoFar.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_BestDualSlaveObjSoFar.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_TimePath.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_SlackValuesBendersCuts.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_SlackValuesMainMasterCons.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_SameCut.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDClass(DUAL)_SameMasterSolution.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);

...
char* FilePath_Results = "C:/PhD_Examples/Results_CrudeOil/BDAux2(DUAL)_new";//G:/Antonis/PhD_Examples
...
int do_dual_slave_and_aux() {
	...
	for (l = 0; l < 1; l++) {
		...
		double LBAuxCon = -IloInfinity, UBAuxCon = 1;
...
int UpdateDualSlaveAuxCon() {
	...
	AuxConl[0].setUB(LowestDualSlaveObjFunction);
...
int PrintOptimalSolution(char* FilePath_Results_ptr, int loop_iter, int NoofTimesWorseSolutionFound) {
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_OptimalSolution.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_LowerBound.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_UpperBound.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_UpperBoundGlobal.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_UpperBoundAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_UpperBoundGlobalAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_dTransY.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_cTransX.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_bTransU.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_cTransXAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_bTransUAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_CurrentHeta.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_BestPrimalSlaveObjSoFar.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_BestDualSlaveObjSoFar.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_TimePath.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_SlackValuesBendersCuts.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_SlackValuesMainMasterCons.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_SameCut.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux2(DUAL)_SameMasterSolution.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);

...
char* FilePath_Results = "C:/PhD_Examples/Results_CrudeOil/BDAux&Feas(DUAL)_new";//G:/Antonis/PhD_Examples
...
int BendersIteration(IloModel modelMaster_ptr, IloModel modelDualSlave_ptr, IloModel modelDualSlaveAux_ptr, IloModel modelDualSlaveFeasAux_ptr, int *loop_iter, int *NoofTimesWorseSolutionFound) {
	...
	while (UpperBoundGlobal - LowerBound > epsilon && loop < 5000 && duration < maxhours * 3600) {
		...
		bTuFeasAux.push_back(FeasAuxDualSlaveObjFunction);
...
int PrintOptimalSolution(char* FilePath_Results_ptr, int loop_iter, int NoofTimesWorseSolutionFound) {
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_OptimalSolution.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_LowerBound.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_UpperBound.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_UpperBoundGlobal.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_UpperBoundAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_UpperBoundGlobalAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_dTransY.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_cTransX.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_bTransU.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_cTransXAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_bTransUAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_bTransUFeasAux.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	for (i = 0; i < bTuFeasAux.size(); i++) {
		outfile << bTuFeasAux.at(i) << std::endl;
	}
	outfile.close();

	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_CurrentHeta.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_BestPrimalSlaveObjSoFar.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_BestDualSlaveObjSoFar.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_TimePath.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_SlackValuesBendersCuts.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_SlackValuesMainMasterCons.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_SameCut.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
	...
	sprintf(filepath, "%s/%s/%s_BDAux&Feas(DUAL)_SameMasterSolution.txt", FilePath_Results_ptr, FileName_Problem_ptr, FileName_Problem_ptr);
	outfile.open(filepath);
